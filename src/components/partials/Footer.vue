    ...
    <div class="-inner -links">
      ...
      <div class="-col -somedia-partner">
        ...
        <div class="-social-links">
          ...
          <a :href="whatsappIcon(constants.RCNLAGOSWHATSAPPNUMBER)" class="-social-link -posrel -whatsapp">
            <div class="-callable" data-type="social link"></div>
        ...
        <NuxtLink href="/partner" class="-btn -partner-btn">become a partner</NuxtLink>
      </div>
    </div>
...
const copyright = computed(() => `© ${new Date().getFullYear()} RCN Lagos. All Rights Reserved.`)
